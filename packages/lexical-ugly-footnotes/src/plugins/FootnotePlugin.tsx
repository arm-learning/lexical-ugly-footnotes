...
import {
  ...
  FootnoteBlockNode,
} from "../nodes/BlockNode.client.js";
import {
      ...
      editor.registerMutationListener(
        ...
        (mutatedNodes, { prevEditorState, dirtyLeaves, updateTags }) => {
          ...
          if (destroyedKeys.length > 0) {
            ...
            const toProcess = destroyedNodes.filter(
              (id) =>
                footnoteService.hasReference(id) ||
                footnoteService.hasBlock(id),
            );
