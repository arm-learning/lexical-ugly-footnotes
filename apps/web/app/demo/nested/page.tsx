  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-4">
        ...
        The editor includes a demo block node that contains a nested editor
        where you can insert footnotes. These nested footnotes will appear
        within the demo block, showing how footnotes can be nested at multiple
        levels.
      </p>
