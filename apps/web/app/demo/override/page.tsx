...
export default async function OverridePage({ searchParams }: OverridePageProps) {
    ...
    return (
        <div>
            ...
            <p className="text-gray-600 mb-4">
                This editor demonstrates how to override the default footnote
                styles using pure CSS. The default classes (like{" "}
                <code className="bg-gray-100 px-1 rounded">.luf-block</code>)
                are overridden with custom styles.
            </p>
