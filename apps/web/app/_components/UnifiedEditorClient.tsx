...
import type { DemoType, SaveResult } from "../_actions/save-content";
import { resetContent, saveContent } from "../_actions/save-content";
const EditorShowcaseCssVars = dynamic(
  () => import("@repo/ui/editor-showcase-css-vars"),
  {
    ssr: false,
  },
);
const EditorShowcaseTheme = dynamic(
  () => import("@repo/ui/editor-showcase-theme"),
  {
    ssr: false,
  },
);
const EditorShowcaseOverride = dynamic(
  () => import("@repo/ui/editor-showcase-override"),
  {
    ssr: false,
  },
);
const EditorShowcaseNested = dynamic(
  () => import("@repo/ui/editor-showcase-nested"),
  {
    ssr: false,
  },
);
const EditorShowcaseHackerNews = dynamic(
  () => import("@repo/ui/editor-showcase-hackernews"),
  {
    ssr: false,
  },
);
...
export function UnifiedEditorClient({
  ...
  const handleReset = () => {
    if (
      !confirm(
        `Are you sure you want to reset the ${demoType} editor? This will clear all saved content.`,
      )
    ) {
      return;
    }
  ...
  const getEditorComponent = () => {
    switch (demoType) {
      ...
      case "theme":
        return (
          <EditorShowcaseTheme submitHandler={handleSubmit} content={content} />
        );
      case "override":
        return (
